...
export default function CompleteProjectModal({ isOpen, projectName, onClose, onConfirm }: CompleteProjectModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="relative max-w-md w-full bg-gray-900 rounded-2xl border border-white/20 shadow-2xl">
        <div className="flex items-center justify-between p-5 border-b border-white/10">
          <h2 className="text-xl font-semibold text-white">Projekt abschließen</h2>
        ...
        <div className="p-6 space-y-4">
          ...
          <p className="text-center text-gray-300">
            Möchten Sie das Projekt <span className="text-white font-semibold">{projectName}</span> als abgeschlossen markieren?
          </p>
          <p className="text-center text-xs text-gray-500">
            Nach Abschluss wird eine automatische Benachrichtigung an den Kunden gesendet.
          </p>
